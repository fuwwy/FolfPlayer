...
public interface PlayableId {
    ...
    static boolean shouldPlay(@NotNull ContextTrackOuterClass.ContextTrack track) {
    ...
    @NotNull
    static PlayableId from(@NotNull ContextTrackOuterClass.ContextTrack track) {
        return fromUri(track.getUri());
    }
    ...
    default boolean matches(@NotNull ContextTrackOuterClass.ContextTrack current) {
