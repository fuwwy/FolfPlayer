...
public final class ProtoUtils {
    ...
    @NotNull
    public static Player.ContextPlayerOptions jsonToPlayerOptions(@NotNull JsonObject obj, @Nullable Player.ContextPlayerOptions old) {
        Player.ContextPlayerOptions.Builder builder = old == null ? Player.ContextPlayerOptions.newBuilder() : old.toBuilder();
    ...
    @NotNull
    public static ContextOuterClass.Context jsonToContext(@NotNull JsonObject obj) {
    ...
    public static void copyOverMetadata(@NotNull ContextOuterClass.Context from, @NotNull Player.PlayerState.Builder to) {
